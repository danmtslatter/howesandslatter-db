                ...
                ?>
                            <tr>
                                <td><?php
                                    ...
                                    $first = false;
                                ?></td>
                                <td class="page level<?php echo $level-1; ?><?php echo ($Page->pagePlaceholder()?' placeholder':''); ?>"><a href="<?php echo $HTML->encode(PERCH_LOGINPATH); ?>/apps/perch_pages/<?php echo ($Page->pagePlaceholder()?'placeholder':'edit'); ?>/?id=<?php echo $HTML->encode(urlencode($Page->id())); ?>"><span><?php echo $HTML->encode($Page->pageTitle())?>
